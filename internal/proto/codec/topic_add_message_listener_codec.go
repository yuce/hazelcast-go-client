...
func DecodeTopicAddMessageListenerResponse(clientMessage *proto.ClientMessage) hazelcast.UUID {
...
func HandleTopicAddMessageListener(clientMessage *proto.ClientMessage, handleTopicEvent func(item serialization.Data, publishTime int64, uuid hazelcast.UUID)) {
