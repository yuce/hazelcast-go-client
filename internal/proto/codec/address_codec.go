...
func EncodeAddress(clientMessage *proto.ClientMessage, address *hazelcast.Address) {
...
func DecodeAddress(frameIterator *proto.ForwardFrameIterator) *hazelcast.Address {
	// begin frame
	frameIterator.Next()
	...
	return hazelcast.NewAddress(host, port)
}
