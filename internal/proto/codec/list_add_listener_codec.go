...
func DecodeListAddListenerResponse(clientMessage *proto.ClientMessage) hazelcast.UUID {
...
func HandleListAddListener(clientMessage *proto.ClientMessage, handleItemEvent func(item serialization.Data, uuid hazelcast.UUID, eventType int32)) {
