...
func DecodeSetAddListenerResponse(clientMessage *proto.ClientMessage) hazelcast.UUID {
...
func HandleSetAddListener(clientMessage *proto.ClientMessage, handleItemEvent func(item serialization.Data, uuid hazelcast.UUID, eventType int32)) {
