...
func DecodeMapAddPartitionLostListenerResponse(clientMessage *proto.ClientMessage) hazelcast.UUID {
...
func HandleMapAddPartitionLostListener(clientMessage *proto.ClientMessage, handleMapPartitionLostEvent func(partitionId int32, uuid hazelcast.UUID)) {
