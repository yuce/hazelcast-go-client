...
func EncodeMapAggregateWithPredicateRequest(name string, aggregator pubserialization.Data, predicate pubserialization.Data) *proto.ClientMessage {
...
func DecodeMapAggregateWithPredicateResponse(clientMessage *proto.ClientMessage) pubserialization.Data {
