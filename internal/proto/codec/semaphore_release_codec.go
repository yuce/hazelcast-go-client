...
func EncodeSemaphoreReleaseRequest(groupId proto.RaftGroupId, name string, sessionId int64, threadId int64, invocationUid hazelcast.UUID, permits int32) *proto.ClientMessage {
