...
func EncodeFencedLockUnlockRequest(groupId proto.RaftGroupId, name string, sessionId int64, threadId int64, invocationUid hazelcast.UUID) *proto.ClientMessage {
