...
func EncodeMapAggregateRequest(name string, aggregator pubserialization.Data) *proto.ClientMessage {
...
func DecodeMapAggregateResponse(clientMessage *proto.ClientMessage) pubserialization.Data {
