...
func EncodeClientRemoveDistributedObjectListenerRequest(registrationId hazelcast.UUID) *proto.ClientMessage {
	clientMessage := proto.NewClientMessageForEncode()
	clientMessage.SetRetryable(true)

	initialFrame := proto.NewFrame(make([]byte, ClientRemoveDistributedObjectListenerCodecRequestInitialFrameSize))
