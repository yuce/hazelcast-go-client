...
func EncodeSimpleEntryView(clientMessage *proto.ClientMessage, simpleEntryView *hazelcast.SimpleEntryView) {
...
func DecodeSimpleEntryView(frameIterator *proto.ForwardFrameIterator) *hazelcast.SimpleEntryView {
	// begin frame
	frameIterator.Next()
	...
	return hazelcast.NewSimpleEntryView(key, value, cost, creationTime, expirationTime, hits, lastAccessTime, lastStoredTime, lastUpdateTime, version, ttl, maxIdle)
}
