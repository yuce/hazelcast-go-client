...
func DecodeMultiMapAddEntryListenerResponse(clientMessage *proto.ClientMessage) hazelcast.UUID {
...
func HandleMultiMapAddEntryListener(clientMessage *proto.ClientMessage, handleEntryEvent func(key serialization.Data, value serialization.Data, oldValue serialization.Data, mergingValue serialization.Data, eventType int32, uuid hazelcast.UUID, numberOfAffectedEntries int32)) {
