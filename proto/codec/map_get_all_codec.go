...
const (
	...
	MapGetAllCodecRequestInitialFrameSize = proto2.PartitionIDOffset + proto2.IntSizeInBytes
)
...
func EncodeMapGetAllRequest(name string, keys []*iserialization.Data) *proto2.ClientMessage {
	clientMessage := proto2.NewClientMessageForEncode()
	clientMessage.SetRetryable(false)

	initialFrame := proto2.NewFrameWith(make([]byte, MapGetAllCodecRequestInitialFrameSize), proto2.UnfragmentedMessage)
...
func DecodeMapGetAllResponse(clientMessage *proto2.ClientMessage) []proto2.Pair {
