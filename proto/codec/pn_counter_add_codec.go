...
const (
	...
	PNCounterAddCodecRequestDeltaOffset             = proto2.PartitionIDOffset + proto2.IntSizeInBytes
	PNCounterAddCodecRequestGetBeforeUpdateOffset   = PNCounterAddCodecRequestDeltaOffset + proto2.LongSizeInBytes
	PNCounterAddCodecRequestTargetReplicaUUIDOffset = PNCounterAddCodecRequestGetBeforeUpdateOffset + proto2.BooleanSizeInBytes
	PNCounterAddCodecRequestInitialFrameSize        = PNCounterAddCodecRequestTargetReplicaUUIDOffset + proto2.UuidSizeInBytes

	PNCounterAddResponseValueOffset        = proto2.ResponseBackupAcksOffset + proto2.ByteSizeInBytes
	PNCounterAddResponseReplicaCountOffset = PNCounterAddResponseValueOffset + proto2.LongSizeInBytes
)
...
func EncodePNCounterAddRequest(name string, delta int64, getBeforeUpdate bool, replicaTimestamps []proto2.Pair, targetReplicaUUID types.UUID) *proto2.ClientMessage {
	clientMessage := proto2.NewClientMessageForEncode()
	clientMessage.SetRetryable(false)

	initialFrame := proto2.NewFrameWith(make([]byte, PNCounterAddCodecRequestInitialFrameSize), proto2.UnfragmentedMessage)
...
func DecodePNCounterAddResponse(clientMessage *proto2.ClientMessage) (value int64, replicaTimestamps []proto2.Pair, replicaCount int32) {
