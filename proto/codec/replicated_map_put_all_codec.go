...
const (
	...
	ReplicatedMapPutAllCodecRequestInitialFrameSize = proto2.PartitionIDOffset + proto2.IntSizeInBytes
)
...
func EncodeReplicatedMapPutAllRequest(name string, entries []proto2.Pair) *proto2.ClientMessage {
	clientMessage := proto2.NewClientMessageForEncode()
	clientMessage.SetRetryable(false)

	initialFrame := proto2.NewFrameWith(make([]byte, ReplicatedMapPutAllCodecRequestInitialFrameSize), proto2.UnfragmentedMessage)
