...
const (
	...
	MapEntriesWithPredicateCodecRequestInitialFrameSize = proto2.PartitionIDOffset + proto2.IntSizeInBytes
)
...
func EncodeMapEntriesWithPredicateRequest(name string, predicate *iserialization.Data) *proto2.ClientMessage {
	clientMessage := proto2.NewClientMessageForEncode()
	clientMessage.SetRetryable(true)

	initialFrame := proto2.NewFrameWith(make([]byte, MapEntriesWithPredicateCodecRequestInitialFrameSize), proto2.UnfragmentedMessage)
...
func DecodeMapEntriesWithPredicateResponse(clientMessage *proto2.ClientMessage) []proto2.Pair {
