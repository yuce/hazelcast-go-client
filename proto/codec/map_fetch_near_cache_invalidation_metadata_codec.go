...
const (
	...
	MapFetchNearCacheInvalidationMetadataCodecRequestUuidOffset       = proto2.PartitionIDOffset + proto2.IntSizeInBytes
	MapFetchNearCacheInvalidationMetadataCodecRequestInitialFrameSize = MapFetchNearCacheInvalidationMetadataCodecRequestUuidOffset + proto2.UuidSizeInBytes
)

// Fetches invalidation metadata from partitions of map.

func EncodeMapFetchNearCacheInvalidationMetadataRequest(names []string, uuid types.UUID) *proto2.ClientMessage {
	clientMessage := proto2.NewClientMessageForEncode()
	clientMessage.SetRetryable(false)

	initialFrame := proto2.NewFrameWith(make([]byte, MapFetchNearCacheInvalidationMetadataCodecRequestInitialFrameSize), proto2.UnfragmentedMessage)
...
func DecodeMapFetchNearCacheInvalidationMetadataResponse(clientMessage *proto2.ClientMessage) (namePartitionSequenceList []proto2.Pair, partitionUuidList []proto2.Pair) {
