...
const (
	...
	ClientAddClusterViewListenerCodecRequestInitialFrameSize = proto2.PartitionIDOffset + proto2.IntSizeInBytes

	ClientAddClusterViewListenerEventMembersViewVersionOffset    = proto2.PartitionIDOffset + proto2.IntSizeInBytes
	ClientAddClusterViewListenerEventPartitionsViewVersionOffset = proto2.PartitionIDOffset + proto2.IntSizeInBytes
)

// Adds a cluster view listener to a connection.

func EncodeClientAddClusterViewListenerRequest() *proto2.ClientMessage {
	clientMessage := proto2.NewClientMessageForEncode()
	clientMessage.SetRetryable(false)

	initialFrame := proto2.NewFrameWith(make([]byte, ClientAddClusterViewListenerCodecRequestInitialFrameSize), proto2.UnfragmentedMessage)
...
func HandleClientAddClusterViewListener(clientMessage *proto2.ClientMessage, handleMembersViewEvent func(version int32, memberInfos []cluster.MemberInfo), handlePartitionsViewEvent func(version int32, partitions []proto2.Pair)) {
