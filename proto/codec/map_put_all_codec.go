...
const (
	...
	MapPutAllCodecRequestTriggerMapLoaderOffset = proto2.PartitionIDOffset + proto2.IntSizeInBytes
	MapPutAllCodecRequestInitialFrameSize       = MapPutAllCodecRequestTriggerMapLoaderOffset + proto2.BooleanSizeInBytes
)
...
func EncodeMapPutAllRequest(name string, entries []proto2.Pair, triggerMapLoader bool) *proto2.ClientMessage {
	clientMessage := proto2.NewClientMessageForEncode()
	clientMessage.SetRetryable(false)

	initialFrame := proto2.NewFrameWith(make([]byte, MapPutAllCodecRequestInitialFrameSize), proto2.UnfragmentedMessage)
